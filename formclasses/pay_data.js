...
class PayDataForm extends BaseFormStructure{
	constructor(props) {
		...
		this.fields = [
			...
			{type: "select", container: 2, size: 6, id: "ciudad", label: "Ciudad", required : true, service: "ciudad", service_index: "departamento"},
			{type: "text", container: 3, size: 12, id: "direccion", label: "Dirección", max: 100, required : true},
			{type: "cell", container: 4, size: 12, id: "celular1", label: "Celular", required: true},
